...
3. Many users running Cloudflare One {props.one} have a default profile that resembles the following. Refer to [WARP client settings](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-settings/) for a description of each setting.
