...
The remoting client serves isolated pages. This client communicates to Cloudflare's network via HTTPS and WebRTC.
...
To pass WebRTC traffic, the remoting client must be able to connect to the following IP addresses:
