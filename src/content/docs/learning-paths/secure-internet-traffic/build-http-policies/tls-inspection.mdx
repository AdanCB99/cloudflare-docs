...
Cloudflare One requires TLS inspection for most advanced security and <GlossaryTooltip term="Cloudflare Data Loss Prevention (DLP)" link="/cloudflare-one/data-loss-prevention/">data loss prevention (DLP)</GlossaryTooltip> features.
