...
Enable Browser Isolation through [Secure Web Gateway HTTP policies](/cloudflare-one/traffic-policies/http-policies/). By default, Browser Isolation does not isolate traffic until you add an Isolate policy to your HTTP policies.
...
Users can check whether Browser Isolation is isolating a web page by using one of the following methods:
...
After you disconnect WARP, refresh the page to return the non-isolated page.
