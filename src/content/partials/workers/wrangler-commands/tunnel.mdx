...
Run a Cloudflare Tunnel using the [cloudflared](/cloudflare-one/connections/connect-networks/downloads/) daemon. This starts a persistent connection between your local machine and Cloudflare's network.
