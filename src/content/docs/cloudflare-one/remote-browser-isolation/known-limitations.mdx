...
Our Network Vector Rendering (NVR) technology allows us to deliver a secure remote computing experience without the bandwidth limitations of video streams. While we expect most websites to work perfectly, Browser Isolation does not support some browser features and web technologies yet, but we plan to implement them in the future:
